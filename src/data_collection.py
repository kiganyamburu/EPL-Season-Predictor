...
def save_transfers(raw_dir='data/raw'):
    ...
    transfers = [
        ...
        {'Team': 'Arsenal', 'Player': 'Thomas Partey', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 15.0, 'Position': 'Midfielder', 'Importance': 0.10},
        {'Team': 'Arsenal', 'Player': 'Jorginho', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 10.0, 'Position': 'Midfielder', 'Importance': 0.08},
        ...
        # Liverpool
        {'Team': 'Liverpool', 'Player': 'Giorgi Mamardashvili', 'TransferType': 'In', 'OtherClub': 'Valencia', 'Fee_M_Euros': 35.0, 'Position': 'Goalkeeper', 'Importance': 0.13},
        {'Team': 'Liverpool', 'Player': 'Freddie Woodman', 'TransferType': 'In', 'OtherClub': 'Preston', 'Fee_M_Euros': 5.0, 'Position': 'Goalkeeper', 'Importance': 0.08},
        {'Team': 'Liverpool', 'Player': 'Ronald Araújo', 'TransferType': 'In', 'OtherClub': 'Barcelona', 'Fee_M_Euros': 70.0, 'Position': 'Defender', 'Importance': 0.15},
        {'Team': 'Liverpool', 'Player': 'Jeremie Frimpong', 'TransferType': 'In', 'OtherClub': 'Bayer Leverkusen', 'Fee_M_Euros': 45.0, 'Position': 'Defender', 'Importance': 0.14},
        {'Team': 'Liverpool', 'Player': 'Milos Kerkez', 'TransferType': 'In', 'OtherClub': 'Bournemouth', 'Fee_M_Euros': 40.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Liverpool', 'Player': 'Giovanni Leoni', 'TransferType': 'In', 'OtherClub': 'Sampdoria', 'Fee_M_Euros': 15.0, 'Position': 'Defender', 'Importance': 0.09},
        {'Team': 'Liverpool', 'Player': 'Jeremy Jacquet', 'TransferType': 'In', 'OtherClub': 'Rennes', 'Fee_M_Euros': 12.0, 'Position': 'Defender', 'Importance': 0.08},
        {'Team': 'Liverpool', 'Player': 'Florian Wirtz', 'TransferType': 'In', 'OtherClub': 'Bayer Leverkusen', 'Fee_M_Euros': 120.0, 'Position': 'Midfielder', 'Importance': 0.18},
        {'Team': 'Liverpool', 'Player': 'Alexander Isak', 'TransferType': 'In', 'OtherClub': 'Newcastle', 'Fee_M_Euros': 130.0, 'Position': 'Forward', 'Importance': 0.18},
        {'Team': 'Liverpool', 'Player': 'Hugo Ekitike', 'TransferType': 'In', 'OtherClub': 'Eintracht Frankfurt', 'Fee_M_Euros': 45.0, 'Position': 'Forward', 'Importance': 0.13},
        {'Team': 'Liverpool', 'Player': 'Bradley Barcola', 'TransferType': 'In', 'OtherClub': 'PSG', 'Fee_M_Euros': 60.0, 'Position': 'Forward', 'Importance': 0.15},
        ...
        {'Team': 'Liverpool', 'Player': 'Victor Muñoz', 'TransferType': 'In', 'OtherClub': 'Real Madrid', 'Fee_M_Euros': 10.0, 'Position': 'Forward', 'Importance': 0.08},
        {'Team': 'Liverpool', 'Player': 'Mohamed Salah', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 80.0, 'Position': 'Forward', 'Importance': 0.18},
        {'Team': 'Liverpool', 'Player': 'Darwin Núñez', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 65.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Liverpool', 'Player': 'Luis Díaz', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 70.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Liverpool', 'Player': 'Diogo Jota', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 50.0, 'Position': 'Forward', 'Importance': 0.13},
        {'Team': 'Liverpool', 'Player': 'Trent Alexander-Arnold', 'TransferType': 'Out', 'OtherClub': 'Real Madrid', 'Fee_M_Euros': 0.0, 'Position': 'Defender', 'Importance': 0.16},
        {'Team': 'Liverpool', 'Player': 'Ibrahima Konaté', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 50.0, 'Position': 'Defender', 'Importance': 0.14},
        {'Team': 'Liverpool', 'Player': 'Andy Robertson', 'TransferType': 'Out', 'OtherClub': 'Tottenham', 'Fee_M_Euros': 25.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Liverpool', 'Player': 'Harvey Elliott', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 35.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Liverpool', 'Player': 'Curtis Jones', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 35.0, 'Position': 'Midfielder', 'Importance': 0.12},
        ...
        # Man United
        {'Team': 'Man United', 'Player': 'Senne Lammens', 'TransferType': 'In', 'OtherClub': 'Antwerp', 'Fee_M_Euros': 20.0, 'Position': 'Goalkeeper', 'Importance': 0.12},
        {'Team': 'Man United', 'Player': 'Karl Darlow', 'TransferType': 'In', 'OtherClub': 'Leeds', 'Fee_M_Euros': 5.0, 'Position': 'Goalkeeper', 'Importance': 0.08},
        {'Team': 'Man United', 'Player': 'Patrick Dorgu', 'TransferType': 'In', 'OtherClub': 'Lecce', 'Fee_M_Euros': 30.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Man United', 'Player': 'Leny Yoro', 'TransferType': 'In', 'OtherClub': 'Lille', 'Fee_M_Euros': 62.0, 'Position': 'Defender', 'Importance': 0.14},
        ...
        {'Team': 'Man United', 'Player': 'Carlos Baleba', 'TransferType': 'In', 'OtherClub': 'Brighton', 'Fee_M_Euros': 65.0, 'Position': 'Midfielder', 'Importance': 0.15},
        {'Team': 'Man United', 'Player': 'Andrey Santos', 'TransferType': 'In', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 35.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Man United', 'Player': 'Youri Tielemans', 'TransferType': 'In', 'OtherClub': 'Aston Villa', 'Fee_M_Euros': 40.0, 'Position': 'Midfielder', 'Importance': 0.14},
        {'Team': 'Man United', 'Player': 'Manuel Ugarte', 'TransferType': 'In', 'OtherClub': 'PSG', 'Fee_M_Euros': 50.0, 'Position': 'Midfielder', 'Importance': 0.14},
        {'Team': 'Man United', 'Player': 'Bryan Mbeumo', 'TransferType': 'In', 'OtherClub': 'Brentford', 'Fee_M_Euros': 65.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Man United', 'Player': 'Matheus Cunha', 'TransferType': 'In', 'OtherClub': 'Wolves', 'Fee_M_Euros': 70.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Man United', 'Player': 'Benjamin Šeško', 'TransferType': 'In', 'OtherClub': 'RB Leipzig', 'Fee_M_Euros': 75.0, 'Position': 'Forward', 'Importance': 0.16},
        {'Team': 'Man United', 'Player': 'Joshua Zirkzee', 'TransferType': 'In', 'OtherClub': 'Bologna', 'Fee_M_Euros': 42.0, 'Position': 'Forward', 'Importance': 0.13},
        {'Team': 'Man United', 'Player': 'Alejandro Garnacho', 'TransferType': 'Out', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 65.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Man United', 'Player': 'Rasmus Højlund', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 60.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Man United', 'Player': 'Antony', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 25.0, 'Position': 'Forward', 'Importance': 0.10},
        {'Team': 'Man United', 'Player': 'Casemiro', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 20.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Man United', 'Player': 'Christian Eriksen', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 0.0, 'Position': 'Midfielder', 'Importance': 0.08},
        ...
        {'Team': 'Man United', 'Player': 'André Onana', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 35.0, 'Position': 'Goalkeeper', 'Importance': 0.14},

        # Tottenham
        {'Team': 'Tottenham', 'Player': 'Antonín Kinský', 'TransferType': 'In', 'OtherClub': 'Slavia Prague', 'Fee_M_Euros': 15.0, 'Position': 'Goalkeeper', 'Importance': 0.10},
        {'Team': 'Tottenham', 'Player': 'Martin Dúbravka', 'TransferType': 'In', 'OtherClub': 'Newcastle', 'Fee_M_Euros': 5.0, 'Position': 'Goalkeeper', 'Importance': 0.08},
        {'Team': 'Tottenham', 'Player': 'Andy Robertson', 'TransferType': 'In', 'OtherClub': 'Liverpool', 'Fee_M_Euros': 25.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Tottenham', 'Player': 'Tosin Adarabioyo', 'TransferType': 'In', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 20.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Tottenham', 'Player': 'Marcos Senesi', 'TransferType': 'In', 'OtherClub': 'Bournemouth', 'Fee_M_Euros': 25.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Tottenham', 'Player': 'Jan Paul van Hecke', 'TransferType': 'In', 'OtherClub': 'Brighton', 'Fee_M_Euros': 35.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Tottenham', 'Player': 'Sandro Tonali', 'TransferType': 'In', 'OtherClub': 'Newcastle', 'Fee_M_Euros': 70.0, 'Position': 'Midfielder', 'Importance': 0.16},
        {'Team': 'Tottenham', 'Player': 'Conor Gallagher', 'TransferType': 'In', 'OtherClub': 'Atletico Madrid', 'Fee_M_Euros': 45.0, 'Position': 'Midfielder', 'Importance': 0.14},
        {'Team': 'Tottenham', 'Player': 'Mateus Fernandes', 'TransferType': 'In', 'OtherClub': 'Southampton', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Tottenham', 'Player': 'Xavi Simons', 'TransferType': 'In', 'OtherClub': 'RB Leipzig', 'Fee_M_Euros': 80.0, 'Position': 'Midfielder', 'Importance': 0.16},
        {'Team': 'Tottenham', 'Player': 'Sávio', 'TransferType': 'In', 'OtherClub': 'Man City', 'Fee_M_Euros': 50.0, 'Position': 'Forward', 'Importance': 0.14},
        ...
        {'Team': 'Tottenham', 'Player': 'Mohammed Kudus', 'TransferType': 'In', 'OtherClub': 'West Ham', 'Fee_M_Euros': 65.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Tottenham', 'Player': 'Omar Marmoush', 'TransferType': 'In', 'OtherClub': 'Eintracht Frankfurt', 'Fee_M_Euros': 55.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Tottenham', 'Player': 'Mykhailo Mudryk', 'TransferType': 'In', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 40.0, 'Position': 'Forward', 'Importance': 0.12},
        {'Team': 'Tottenham', 'Player': 'Wilson Odobert', 'TransferType': 'In', 'OtherClub': 'Burnley', 'Fee_M_Euros': 30.0, 'Position': 'Forward', 'Importance': 0.10},
        {'Team': 'Tottenham', 'Player': 'Son Heung-min', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 40.0, 'Position': 'Forward', 'Importance': 0.16},
        {'Team': 'Tottenham', 'Player': 'Guglielmo Vicario', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 35.0, 'Position': 'Goalkeeper', 'Importance': 0.14},
        {'Team': 'Tottenham', 'Player': 'Cristian Romero', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 60.0, 'Position': 'Defender', 'Importance': 0.15},
        {'Team': 'Tottenham', 'Player': 'Yves Bissouma', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 25.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Tottenham', 'Player': 'Pape Matar Sarr', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.12},
        {'Team': 'Tottenham', 'Player': 'Brennan Johnson', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 45.0, 'Position': 'Forward', 'Importance': 0.13},
        {'Team': 'Tottenham', 'Player': 'Richarlison', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 35.0, 'Position': 'Forward', 'Importance': 0.12},
        ...
        {'Team': 'Tottenham', 'Player': 'Joe Rodon', 'TransferType': 'Out', 'OtherClub': 'Leeds', 'Fee_M_Euros': 12.0, 'Position': 'Defender', 'Importance': 0.08},
        ...
        {'Team': 'Aston Villa', 'Player': 'Marco Bizot', 'TransferType': 'In', 'OtherClub': 'Brest', 'Fee_M_Euros': 12.0, 'Position': 'Goalkeeper', 'Importance': 0.12},
        {'Team': 'Aston Villa', 'Player': 'Zion Suzuki', 'TransferType': 'In', 'OtherClub': 'Parma', 'Fee_M_Euros': 15.0, 'Position': 'Goalkeeper', 'Importance': 0.12},
        {'Team': 'Aston Villa', 'Player': 'Victor Lindelöf', 'TransferType': 'In', 'OtherClub': 'Man United', 'Fee_M_Euros': 10.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Aston Villa', 'Player': 'Aaron Wan-Bissaka', 'TransferType': 'In', 'OtherClub': 'West Ham', 'Fee_M_Euros': 18.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Aston Villa', 'Player': 'Taylor Harwood-Bellis', 'TransferType': 'In', 'OtherClub': 'Southampton', 'Fee_M_Euros': 20.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Aston Villa', 'Player': 'Matteo Ruggeri', 'TransferType': 'In', 'OtherClub': 'Atalanta', 'Fee_M_Euros': 22.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Aston Villa', 'Player': 'Leon Goretzka', 'TransferType': 'In', 'OtherClub': 'Bayern Munich', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.15},
        {'Team': 'Aston Villa', 'Player': 'João Gomes', 'TransferType': 'In', 'OtherClub': 'Wolves', 'Fee_M_Euros': 35.0, 'Position': 'Midfielder', 'Importance': 0.14},
        {'Team': 'Aston Villa', 'Player': 'Ross Barkley', 'TransferType': 'In', 'OtherClub': 'Luton', 'Fee_M_Euros': 5.0, 'Position': 'Midfielder', 'Importance': 0.10},
        {'Team': 'Aston Villa', 'Player': 'Nicolas Jackson', 'TransferType': 'In', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 55.0, 'Position': 'Forward', 'Importance': 0.16},
        {'Team': 'Aston Villa', 'Player': 'Alejandro Garnacho', 'TransferType': 'In', 'OtherClub': 'Man United', 'Fee_M_Euros': 60.0, 'Position': 'Forward', 'Importance': 0.16},
        {'Team': 'Aston Villa', 'Player': 'Tammy Abraham', 'TransferType': 'In', 'OtherClub': 'Roma', 'Fee_M_Euros': 25.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Aston Villa', 'Player': 'Ezri Konsa', 'TransferType': 'Out', 'OtherClub': 'Arsenal', 'Fee_M_Euros': 45.0, 'Position': 'Defender', 'Importance': 0.14},
        {'Team': 'Aston Villa', 'Player': 'Emiliano Martínez', 'TransferType': 'Out', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 40.0, 'Position': 'Goalkeeper', 'Importance': 0.15},
        {'Team': 'Aston Villa', 'Player': 'Morgan Rogers', 'TransferType': 'Out', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 50.0, 'Position': 'Forward', 'Importance': 0.14},
        ...
        {'Team': 'Aston Villa', 'Player': 'Ollie Watkins', 'TransferType': 'Out', 'OtherClub': 'Transferred', 'Fee_M_Euros': 60.0, 'Position': 'Forward', 'Importance': 0.18},
        ...
        {'Team': 'Newcastle', 'Player': 'Lukas Hornicek', 'TransferType': 'In', 'OtherClub': 'Braga', 'Fee_M_Euros': 8.0, 'Position': 'Goalkeeper', 'Importance': 0.10},
        {'Team': 'Newcastle', 'Player': 'Amar Dedić', 'TransferType': 'In', 'OtherClub': 'Salzburg', 'Fee_M_Euros': 20.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Newcastle', 'Player': 'Malick Thiaw', 'TransferType': 'In', 'OtherClub': 'AC Milan', 'Fee_M_Euros': 35.0, 'Position': 'Defender', 'Importance': 0.14},
        {'Team': 'Newcastle', 'Player': 'Nicolás González', 'TransferType': 'In', 'OtherClub': 'Fiorentina', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.13},
        {'Team': 'Newcastle', 'Player': 'Jacob Ramsey', 'TransferType': 'In', 'OtherClub': 'Aston Villa', 'Fee_M_Euros': 38.0, 'Position': 'Midfielder', 'Importance': 0.13},
        {'Team': 'Newcastle', 'Player': 'Anthony Elanga', 'TransferType': 'In', 'OtherClub': 'Nott\'m Forest', 'Fee_M_Euros': 45.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Newcastle', 'Player': 'Yoane Wissa', 'TransferType': 'In', 'OtherClub': 'Brentford', 'Fee_M_Euros': 35.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Newcastle', 'Player': 'Alexander Isak', 'TransferType': 'Out', 'OtherClub': 'Liverpool', 'Fee_M_Euros': 130.0, 'Position': 'Forward', 'Importance': 0.20},
        {'Team': 'Newcastle', 'Player': 'Sandro Tonali', 'TransferType': 'Out', 'OtherClub': 'Tottenham', 'Fee_M_Euros': 65.0, 'Position': 'Midfielder', 'Importance': 0.16},
        ...
        {'Team': 'Brighton', 'Player': 'Mats Wieffer', 'TransferType': 'In', 'OtherClub': 'Feyenoord', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.13},
        {'Team': 'Brighton', 'Player': 'Ferdi Kadioglu', 'TransferType': 'In', 'OtherClub': 'Fenerbahce', 'Fee_M_Euros': 30.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Brighton', 'Player': 'Matt O\'Riley', 'TransferType': 'In', 'OtherClub': 'Celtic', 'Fee_M_Euros': 30.0, 'Position': 'Midfielder', 'Importance': 0.13},
        {'Team': 'Brighton', 'Player': 'Brajan Gruda', 'TransferType': 'In', 'OtherClub': 'Mainz 05', 'Fee_M_Euros': 30.0, 'Position': 'Forward', 'Importance': 0.13},
        {'Team': 'Brighton', 'Player': 'Olivier Boscagli', 'TransferType': 'In', 'OtherClub': 'PSV', 'Fee_M_Euros': 20.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Brighton', 'Player': 'Maxim De Cuyper', 'TransferType': 'In', 'OtherClub': 'Club Brugge', 'Fee_M_Euros': 20.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Brighton', 'Player': 'Diego Coppola', 'TransferType': 'In', 'OtherClub': 'Hellas Verona', 'Fee_M_Euros': 15.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Brighton', 'Player': 'Luka Vušković', 'TransferType': 'In', 'OtherClub': 'Spurs / Hajduk', 'Fee_M_Euros': 14.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Brighton', 'Player': 'Diego Gómez', 'TransferType': 'In', 'OtherClub': 'Inter Miami', 'Fee_M_Euros': 14.0, 'Position': 'Midfielder', 'Importance': 0.11},
        {'Team': 'Brighton', 'Player': 'Charalampos Kostoulas', 'TransferType': 'In', 'OtherClub': 'Olympiacos', 'Fee_M_Euros': 12.0, 'Position': 'Forward', 'Importance': 0.10},
        {'Team': 'Brighton', 'Player': 'Stefanos Tzimas', 'TransferType': 'In', 'OtherClub': 'PAOK', 'Fee_M_Euros': 12.0, 'Position': 'Forward', 'Importance': 0.10},
        {'Team': 'Brighton', 'Player': 'Joao Pedro', 'TransferType': 'Out', 'OtherClub': 'Chelsea', 'Fee_M_Euros': 60.0, 'Position': 'Forward', 'Importance': 0.16},
        ...
        # Leeds (Promoted)
        {'Team': 'Leeds', 'Player': 'James Trafford', 'TransferType': 'In', 'OtherClub': 'Burnley', 'Fee_M_Euros': 18.0, 'Position': 'Goalkeeper', 'Importance': 0.13},
        {'Team': 'Leeds', 'Player': 'Lucas Perri', 'TransferType': 'In', 'OtherClub': 'Lyon', 'Fee_M_Euros': 10.0, 'Position': 'Goalkeeper', 'Importance': 0.11},
        {'Team': 'Leeds', 'Player': 'Jayden Bogle', 'TransferType': 'In', 'OtherClub': 'Sheffield United', 'Fee_M_Euros': 6.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Leeds', 'Player': 'Gabriel Gudmundsson', 'TransferType': 'In', 'OtherClub': 'Lille', 'Fee_M_Euros': 12.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Leeds', 'Player': 'Tarik Muharemović', 'TransferType': 'In', 'OtherClub': 'Juventus', 'Fee_M_Euros': 8.0, 'Position': 'Defender', 'Importance': 0.11},
        {'Team': 'Leeds', 'Player': 'Joe Rodon', 'TransferType': 'In', 'OtherClub': 'Tottenham', 'Fee_M_Euros': 12.0, 'Position': 'Defender', 'Importance': 0.14},
        {'Team': 'Leeds', 'Player': 'Jaka Bijol', 'TransferType': 'In', 'OtherClub': 'Udinese', 'Fee_M_Euros': 15.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Leeds', 'Player': 'James Justin', 'TransferType': 'In', 'OtherClub': 'Leicester', 'Fee_M_Euros': 10.0, 'Position': 'Defender', 'Importance': 0.12},
        {'Team': 'Leeds', 'Player': 'Nico Elvedi', 'TransferType': 'In', 'OtherClub': 'Borussia Monchengladbach', 'Fee_M_Euros': 12.0, 'Position': 'Defender', 'Importance': 0.13},
        {'Team': 'Leeds', 'Player': 'Sean Longstaff', 'TransferType': 'In', 'OtherClub': 'Newcastle', 'Fee_M_Euros': 15.0, 'Position': 'Midfielder', 'Importance': 0.13},
        {'Team': 'Leeds', 'Player': 'Anton Stach', 'TransferType': 'In', 'OtherClub': 'Hoffenheim', 'Fee_M_Euros': 16.0, 'Position': 'Midfielder', 'Importance': 0.14},
        ...
        {'Team': 'Leeds', 'Player': 'Dominic Calvert-Lewin', 'TransferType': 'In', 'OtherClub': 'Everton', 'Fee_M_Euros': 25.0, 'Position': 'Forward', 'Importance': 0.16},
        {'Team': 'Leeds', 'Player': 'Harry Wilson', 'TransferType': 'In', 'OtherClub': 'Fulham', 'Fee_M_Euros': 15.0, 'Position': 'Forward', 'Importance': 0.14},
        {'Team': 'Leeds', 'Player': 'Noah Okafor', 'TransferType': 'In', 'OtherClub': 'AC Milan', 'Fee_M_Euros': 18.0, 'Position': 'Forward', 'Importance': 0.15},
        {'Team': 'Leeds', 'Player': 'Lukas Nmecha', 'TransferType': 'In', 'OtherClub': 'Wolfsburg', 'Fee_M_Euros': 10.0, 'Position': 'Forward', 'Importance': 0.12},
        {'Team': 'Leeds', 'Player': 'Jean-Mattéo Bahoya', 'TransferType': 'In', 'OtherClub': 'Eintracht Frankfurt', 'Fee_M_Euros': 8.0, 'Position': 'Forward', 'Importance': 0.11},
